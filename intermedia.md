...
Desarrolla el backend de **BildyApp**, una API REST con Node.js y Express para la gestión de albaranes. En esta práctica intermedia implementarás el módulo completo de **gestión de usuarios**, incluyendo registro, autenticación, onboarding y administración de cuentas.
